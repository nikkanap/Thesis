...
def MLP_Model(predictions_dir, X_train, y_train, testing_data, fold_id, random_seed, b=None):
    ...
    for test in testing_data:
        csv_file_path = f'{predictions_dir}/MLP_Predictions_{test['name']}_{fold_id}.csv'
